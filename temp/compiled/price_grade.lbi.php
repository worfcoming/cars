...
?>
    ...
    <img src="themes/car/images/alone.gif" style=" margin-right:8px;"><font class="f1 f5"><?php echo $this->_var['grade']['start']; ?> - <?php echo $this->_var['grade']['end']; ?> <?php if ($this->_var['grade']['goods_num']): ?>(<?php echo $this->_var['grade']['goods_num']; ?>)<?php endif; ?></font><br />
    <?php else: ?>
