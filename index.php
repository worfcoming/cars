...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
    ...
    $smarty->assign('best_goods',      get_recommend_goods('best',0 ,$cid));    // 推荐商品
    $smarty->assign('new_goods',       get_recommend_goods('new',0 ,$cid));     // 最新商品
    $smarty->assign('hot_goods',       get_recommend_goods('hot',0 ,$cid));     // 热点文章
