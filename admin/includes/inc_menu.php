...
//车系管理
$modules['01_cars']['cbrand_list']       = 'cbrand.php?act=list';         // 品牌列表
$modules['01_cars']['csys_list']        = 'csys.php?act=list';          // 车系列表
$modules['01_cars']['ctype_list']    = 'ctype.php?act=list';         // 车款列表
